...
<body>
    <div class="flex items-center justify-center h-screen w-full bg-gray-300 ">
        <div class="w-96 min-h-96 h-max bg-white  shadow-xl flex flex-col items-center rounded">
            ...
            <p class="text-2xl font-bold mt-2 mb-7">Sign In User</p>
            <form action="{{ route('user.login.submit')  }}" method="post" class="w-full flex flex-col items-center gap-3 mb-1">
                @csrf
            ...
            <div class="w-full h-10 bg-gray-300 mt-12 flex items-center justify-center gap-1">
                ...
                <a href="{{route('user.register')}}" class="font-normal text-blue-400 text-sm">Create Accout</a>
            </div>
        </div>
    </div>
</body>
